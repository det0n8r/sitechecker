    ...
    class DataGridViewColumnSelector
    {
        ...
        public DataGridView DataGridView
        {
            ...
            set { 
                  ...
                  if (mDataGridView != null) mDataGridView.MouseClick += new MouseEventHandler(mDataGridView_CellMouseClick);//mDataGridView.CellMouseClick += new DataGridViewCellMouseEventHandler(mDataGridView_CellMouseClick);
              }
        }
        ...
        void mDataGridView_CellMouseClick(object sender, MouseEventArgs e)//DataGridViewCellMouseEventArgs e)
        {            
