...
namespace XDSiteChecker
{
    public partial class Main : Form
    {
        ...
        static SecureString pw = new SecureString();
        string[] cred;
        WindowsIdentity altUser;
        //PSCredential cred = new PSCredential("test",pw); 
        #endregion
        #region Inits 
        ...
        public string RunScript(string scriptText, string[] param)
        {
        ...
        #region Functions
        // Main Site build               
        public static WindowsIdentity ImpersonateUser(string sUsername, string sDomain, string sPassword)
        {
            // initialize tokens
